...
//Generic SinglyLL (int, char, double & float)
...
void SinglyLL<T>::InsertFirst(T No)
{
    ...
    newn = new node<T> ;        //malloc--dynamic memory alloacte in cpp
...
void SinglyLL<T>::InsertLast(T No)
{
    ...
    newn = new node<T>;        //struct node chya tithe node  //malloc--dynamic memory alloacte in cpp
...
int main()
{
    ...
    dobj->InsertFirst(10.5621);
    dobj->InsertFirst(34.5623);
    dobj->InsertFirst(13.6745);
    ...
    dobj->InsertLast(23.5367);
    dobj->InsertLast(56.7809);
    dobj->InsertLast(57.0712);
